...
Query Functions는 말 그대로 어떤 함수든 될 수 있다. (promise을 반환하는) <br />
...
axios나 graphql-request와 같은 대부분의 유틸리티는 실패한 HTTP 호출에 대해 자동으로 오류를 던지지만, <br />
...
Query keys는 가져오는 데이터를 고유하게 식별하기 위한 것일 뿐만 아니라, <br />
QueryFunctionContext의 일부로 Query Function에 알맞게 전달됩니다. <br />
