...
contoller 파일에서 service의 기능을 어떻게 쓸 수 있을까? <br />
...
NestJS는 여러가지 모듈들을 레고처럼 조합해서 합친다. <br />
그렇지만 CLI로 생성하니 자동으로 AppModule에 추가된다. <br />
...
코드를 보면, NestFactory에 App 모듈을 넣어주고 있고, <br />
3000번 포트에서 실행하고 있다.
